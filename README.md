...
|&nbsp;&nbsp;팀&nbsp;원&nbsp;&nbsp;&nbsp;|회고록|
|:---:|---|
|최종찬| OmokHub의 Front를 구현하는 이번 프로젝트는 팀원들과 재미있고 창의로운 아이디어를 공유하는 기회이자, HTML, CSS, JavaScript, Vue를 활용할 수 있는 좋은 기회였습니다.<br>팀원들과 소통하며, 상상하던 웹 페이지를 직접 구현해내가는 과정이 즐거웠으며, 데이터가 실제 웹 화면으로 이동하는 과정을 직접 구현하는 새로운 경험을 쌓을 수 있었습니다.<br>이번 단계에서는 Json 파일을 통한 직접 통신 시스템을 구축했지만, 향후에는 이전에 구현한 OmokHub의 Backend와의 통합을 통해 실질적인 서비스를 제공하는 통합 OmokHub를 구현할 것입니다.<br>  |

  <template>
      <div class="seeking-post-content">
              <div class="seeking-post-content-2">
                ...
                <div class="group-4">
                  <div class="overlap-group-4"><div class="text-wrapper-5">어떤 팀원을 구하고 있나요?</div></div>
                </div>
              </div>
            ...
            <div class="button">
              <div class="group-5">
                <div class="overlap-group-5"><div class="text-wrapper-6">등록</div></div>
              </div>
            </div>   
  </template>
  ...
  .writing-detail {
    width: 80%; /* 화면 너비의 80%로 조정 */
    max-width: 319px; /* 최대 너비를 319px로 제한 */
  }

  .group-5 {
    width: 90%; /* 화면 너비의 90%로 조정 */
    max-width: 236px; /* 최대 너비를 236px로 제한 */
  }
